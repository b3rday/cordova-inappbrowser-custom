...
- (void)createViews
{
    ...
    BOOL toolbarIsAtBottom = [_browserOptions.toolbarposition isEqualToString:kInAppBrowserToolbarBarPositionBottom];
    
    webViewBounds.size.height -= TOOLBAR_HEIGHT;
    webViewBounds.size.height -= [self getStatusBarOffset];
    ...
    self.closeButton = [[UIBarButtonItem alloc] initWithTitle:@"❮" style:UIBarButtonItemStylePlain target:self action:@selector(close)];
    self.closeButton.enabled = YES;
    
    
    float toolbarY = toolbarIsAtBottom ? self.view.bounds.size.height - TOOLBAR_HEIGHT : [self getStatusBarOffset];
...
{
    self.closeButton.title = [@"❮" stringByAppendingFormat:@" %@", title];
}
...
- (void)rePositionViews {
    if ([_browserOptions.toolbarposition isEqualToString:kInAppBrowserToolbarBarPositionTop]) {
        [self.webView setFrame:CGRectMake(self.webView.frame.origin.x, TOOLBAR_HEIGHT + [self getStatusBarOffset], self.webView.frame.size.width, self.view.bounds.size.height - TOOLBAR_HEIGHT - [self getStatusBarOffset])];
